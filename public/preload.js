...
contextBridge.exposeInMainWorld(
    "api", {
        ...
        getReports:(filter)=>ipcRenderer.invoke('getReports', filter),
        ...
        getInvoices:(filter)=>ipcRenderer.invoke('getInvoices', filter),
        getInvoice:(invoice_id)=>ipcRenderer.invoke('getInvoice', invoice_id),
        getPatients:(filter)=>ipcRenderer.invoke('getPatients', filter),
